...
list REPLACE_NUM=[
	...
	-811, "PLUGIN_MENU_RESPONSE", "The Menu response for use in menu plugins.",
	-812, "PLUGIN_MENU_SHOW", "The improved DOMENU call for plugins.",
	-813, "PLUGIN_MENU_CHANGE_PATH", "A PREPARE_REMENU message for menu plugins.",
