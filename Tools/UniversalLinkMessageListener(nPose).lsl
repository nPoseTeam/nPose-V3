...
list REPLACE_NUM=[
	...
	207, "DOACTIONS", "core sends out this when a link message is found in notecard or in memory data for current pose set.  Mostly applies to BTN notecards.", 
	...
	223, "DOACTION_READER", "With the addition of 'nPose NC Reader' script for cache of pose set button selections, this is used to send the button command to the core.", 
