...
//            string faces = "";
            ...
            llSay(chatchannel, "adjuster_die"); 
            adjusters = [];
        }else if (num == 2 && str == "RezAdjuster"){    //got a new pose so update adjusters.
            adjusters = [];
            RezNextAdjuster();
        }else if (num == 3){    //heard from an adjuster so a new position must be used, upate slots and chat out new position.
