...
fetchNcContent(string str, key id, integer type) {
    ...
    list parts=llParseStringKeepNulls(str, [CONTENT_SEPARATOR], []);
    ...
    do{
        ...
        if(~index) {
            ...
            llMessageLinked(
                ...
                llDumpList2String(llList2List(responseStack, 0, 2) + llList2String(cacheContent, index), CONTENT_SEPARATOR),
